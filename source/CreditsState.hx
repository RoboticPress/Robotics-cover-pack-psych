...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Members of the Discord Server','discord',	'These guys are pretty awesome they supported me all the way, you should join it lol',						'https://discord.gg/kCBc7vhPyh',							'FFD2BC'],
			['All other mods',		'robotic',			'Every mod that\'s used in the cover pack is credited in the data folder of the cover it appeared in',		'https://www.youtube.com/watch?v=fQ3uS6TR3w8',				'00FFE5	'],
			['Psych Engine Team'],
